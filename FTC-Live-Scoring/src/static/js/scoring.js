$(function() {
  ...
  function localReset(){
	...
	['.rcen', '.rcor', '.bcen', '.bcor'].forEach(function(elementId) {
  ...
  // Click events
  document.getElementById("r1p").onclick = function() {add('.rcen', 1)};
  document.getElementById("r1m").onclick = function() {sub('.rcen', 1)};
  document.getElementById("r2p").onclick = function() {add('.rcor', 2)};
  document.getElementById("r2m").onclick = function() {sub('.rcor', 2)};
